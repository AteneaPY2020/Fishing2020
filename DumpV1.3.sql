CREATE DATABASE  IF NOT EXISTS `fishingdb` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fishingdb`;
...
CREATE TABLE `emprendimiento` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_emprendimiento_localidad1_idx` (`id_localidad`),
  KEY `fk_emprendimiento_usuario1_idx` (`id_usuario`),
  CONSTRAINT `fk_emprendimiento_localidad1` FOREIGN KEY (`id_localidad`) REFERENCES `localidad` (`id`),
...
INSERT INTO `emprendimiento` VALUES (1,'Puseria Mary','Tiburon','Negocio familiar que vende pupusas','','mary@pusas.sv','22555555',NULL,'Barriga llena, corazón contento',0,'0000-00-00',0,0,1,3),(2,'Crown','Pez dorado','Venta de accesorios','','crown@diademas.com','23456789',NULL,'Ninnas bonitas con diadema',0,'0000-00-00',0,0,1,4);
...
CREATE TABLE `inversionista` (
  ...
  `foto` longblob,
  PRIMARY KEY (`id`),
  KEY `fk_inversionista_localidad1_idx` (`id_localidad`),
  KEY `fk_inversionista_usuario1_idx` (`id_usuario`),
  CONSTRAINT `fk_inversionista_localidad1` FOREIGN KEY (`id_localidad`) REFERENCES `localidad` (`id`),
...
INSERT INTO `inversionista` VALUES (1,'Mark Cuban','Dueño de los Dallas Maveriks','mark@$$.com',0,1,1,NULL),(2,'Lori Greiner','Mi patrimonio es de 70 millones ;)','lori@baby.com',0,1,2,NULL);
...
INSERT INTO `localidad` VALUES (1,'El Salvador','San Salvador');
...
CREATE TABLE `usuario` (
  ...
  `rol` tinyint NOT NULL COMMENT '"0-inversionista", "1-emprendedor"',
  PRIMARY KEY (`id`)
...
INSERT INTO `usuario` VALUES (1,'markcubar','12345',0),(2,'lorigreiner','lori90',0),(3,'pupusasmary','pupas123',1),(4,'crown','beautycrown123',1);
...
-- Dump completed on 2020-07-20 15:52:38
